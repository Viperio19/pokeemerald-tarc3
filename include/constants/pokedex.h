...
#define POKEMON_SLOTS_NUMBER (REGIONAL_DEX_COUNT + 1)
#define POKEMON_SLOTS_NUMBER_NATIONAL (NATIONAL_DEX_COUNT + 1)
...
#define HOENN_DEX_COUNT (HOENN_DEX_VOLCANION + 1)
