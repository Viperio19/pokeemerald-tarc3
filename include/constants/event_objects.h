...
enum
{
    ...
    OBJ_EVENT_GFX_PLAYER_M_NORMAL,
    OBJ_EVENT_GFX_PLAYER_M_MACH_BIKE,
    OBJ_EVENT_GFX_PLAYER_M_ACRO_BIKE,
    OBJ_EVENT_GFX_PLAYER_M_SURFING,
    OBJ_EVENT_GFX_PLAYER_M_FIELD_MOVE,
    OBJ_EVENT_GFX_PLAYER_M_UNDERWATER,
    OBJ_EVENT_GFX_PLAYER_M_FISHING,
    OBJ_EVENT_GFX_PLAYER_M_WATERING,
    OBJ_EVENT_GFX_PLAYER_F_NORMAL,
    OBJ_EVENT_GFX_PLAYER_F_MACH_BIKE,
    OBJ_EVENT_GFX_PLAYER_F_ACRO_BIKE,
    OBJ_EVENT_GFX_PLAYER_F_SURFING,
    OBJ_EVENT_GFX_PLAYER_F_FIELD_MOVE,
    OBJ_EVENT_GFX_PLAYER_F_UNDERWATER,
    OBJ_EVENT_GFX_PLAYER_F_FISHING,
    OBJ_EVENT_GFX_PLAYER_F_WATERING,
    OBJ_EVENT_GFX_PLAYER_2_M_NORMAL,
    OBJ_EVENT_GFX_PLAYER_2_M_MACH_BIKE,
    OBJ_EVENT_GFX_PLAYER_2_M_ACRO_BIKE,
    OBJ_EVENT_GFX_PLAYER_2_M_SURFING,
    OBJ_EVENT_GFX_PLAYER_2_M_FIELD_MOVE,
    OBJ_EVENT_GFX_PLAYER_2_M_UNDERWATER,
    OBJ_EVENT_GFX_PLAYER_2_M_FISHING,
    OBJ_EVENT_GFX_PLAYER_2_M_WATERING,
    OBJ_EVENT_GFX_PLAYER_2_F_NORMAL,
    OBJ_EVENT_GFX_PLAYER_2_F_MACH_BIKE,
    OBJ_EVENT_GFX_PLAYER_2_F_ACRO_BIKE,
    OBJ_EVENT_GFX_PLAYER_2_F_SURFING,
    OBJ_EVENT_GFX_PLAYER_2_F_FIELD_MOVE,
    OBJ_EVENT_GFX_PLAYER_2_F_UNDERWATER,
    OBJ_EVENT_GFX_PLAYER_2_F_FISHING,
    OBJ_EVENT_GFX_PLAYER_2_F_WATERING,
    OBJ_EVENT_GFX_EXEGGUTOR,
    OBJ_EVENT_GFX_HP_BAR_GREEN,
    OBJ_EVENT_GFX_HP_BAR_GREEN_PARA,
    OBJ_EVENT_GFX_HP_BAR_GREEN_PARA_STATS,
    OBJ_EVENT_GFX_HP_BAR_GREEN_STATS,
    OBJ_EVENT_GFX_HP_BAR_YELLOW,
    OBJ_EVENT_GFX_HP_BAR_YELLOW_PARA,
    OBJ_EVENT_GFX_HP_BAR_YELLOW_PARA_STATS,
    OBJ_EVENT_GFX_HP_BAR_YELLOW_STATS,
    OBJ_EVENT_GFX_HP_BAR_RED,
    OBJ_EVENT_GFX_HP_BAR_RED_PARA,
    OBJ_EVENT_GFX_HP_BAR_RED_PARA_STATS,
    OBJ_EVENT_GFX_HP_BAR_RED_STATS,
    OBJ_EVENT_GFX_ZINNIA,
    OBJ_EVENT_GFX_JESSIE,
    OBJ_EVENT_GFX_JAMES,
    OBJ_EVENT_GFX_TEAM_ROCKET_MEOWTH,
    OBJ_EVENT_GFX_ROCK_SLIDE_ROCK,
    OBJ_EVENT_GFX_CRAMORANT,
    OBJ_EVENT_GFX_CRAMORANT_GORGING,
    NUM_OBJ_EVENT_GFX,
};
...
#define OBJ_EVENT_PAL_TAG_PLAYER_M                0x1134
#define OBJ_EVENT_PAL_TAG_PLAYER_M_REFLECTION     0x1135
#define OBJ_EVENT_PAL_TAG_PLAYER_F                0x1136
#define OBJ_EVENT_PAL_TAG_PLAYER_F_REFLECTION     0x1137
#define OBJ_EVENT_PAL_TAG_PLAYER_2_M              0x1138
#define OBJ_EVENT_PAL_TAG_PLAYER_2_M_REFLECTION   0x1139
#define OBJ_EVENT_PAL_TAG_PLAYER_2_F              0x113A
#define OBJ_EVENT_PAL_TAG_PLAYER_2_F_REFLECTION   0x113B
#define OBJ_EVENT_PAL_TAG_EXEGGUTOR               0x113C
#define OBJ_EVENT_PAL_TAG_HP_BAR                  0x113D
...
#define OBJ_EVENT_PAL_TAG_CRAMORANT_GORGING       0x1142
