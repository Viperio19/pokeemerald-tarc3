...
ALIGNED(4) const u16 gFontSmallLowerLatinGlyphs[] = INCGFX_U16("graphics/fonts/latin_small_lower.png", ".latfont");
...
ALIGNED(4) const u16 gFontSmallLatinGlyphsFRLG[] = INCGFX_U16("graphics/fonts/latin_small_frlg.png", ".latfont");
ALIGNED(4) const u8 gFontSmallLatinGlyphWidthsFRLG[] = 
{
...
ALIGNED(4) const u16 gFontNormalLatinGlyphsFRLG[] = INCGFX_U16("graphics/fonts/latin_normal_frlg.png", ".latfont");
ALIGNED(4) const u8 gFontNormalLatinGlyphWidthsFRLG[] =
{
