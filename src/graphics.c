...
const u16 gTitleScreenBgPalettes[]         = INCBIN_U16("graphics/title_screen/pokemon_logo.gbapal",
                                                        "graphics/title_screen/mt_chimney_and_clouds.gbapal");
const u16 gTitleScreenEmeraldVersionPal[]  = INCGFX_U16("graphics/title_screen/tag_team_trials.png", ".gbapal");
const u32 gTitleScreenCloudsTilemap[]      = INCGFX_U32("graphics/title_screen/clouds_with_logos.bin", ".smolTM");
const u32 gTitleScreenPokemonLogoGfx[]     = INCGFX_U32("graphics/title_screen/pokemon_logo.png", ".8bpp.smol");
const u32 gTitleScreenEmeraldVersionGfx[]  = INCGFX_U32("graphics/title_screen/tag_team_trials.png", ".8bpp.smol", "-mwidth 8 -mheight 4");
const u16 gTitleScreenPressStartPal[]      = INCGFX_U16("graphics/title_screen/press_start_team.png", ".gbapal");
const u32 gTitleScreenPressStartGfx[]      = INCGFX_U32("graphics/title_screen/press_start_team.png", ".4bpp.smol");
